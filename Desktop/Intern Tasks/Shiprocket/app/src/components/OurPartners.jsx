...
import Partner10 from '../assets/images/Partner2.png'
...
function OurPartners() {
  ...
  return (
    <div className='max-w-6xl mx-auto relative px-2'>
        <h2 className='text-5xl font-bold my-20 text-primes'>Our <span className='custom-gradient font-normal'>Partners</span></h2>
        <div>
            <p className='font-semibold text-burgundy bg-[#F0EDFF] py-2 px-2 text-center w-56 rounded-md'>FTL Carrier Network</p>
            <div className='flex w-full justify-between  my-6  items-center overflow-scroll gap-y-8 h-24 scrollbar-hidden  md:flex-wrap'>
                {
        ...
        <div>
            ...
            <div className='flex w-full justify-between  my-6  items-center  scrollbar-hidden overflow-scroll     md:flex-wrap'>
                {
