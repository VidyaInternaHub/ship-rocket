...
function TrustedPartner() {
  return (
    ...
    <div className="max-w-6xl mx-auto px-2">
        ...
        <h3 className='text-5xl font-bold  my-8 text-primes'>Your trusted partner for <span className='custom-gradient font-normal'>heavy shipments,</span><br />
        ...
        <div className='flex justify-between w-full my-16 scrollbar-hidden overflow-auto gap-6 md:mx-0 mx-4'>
