...
import Cargostep1 from '../assets/images/Cargostep1.png';
import Cargostep2 from '../assets/images/Cargostep2.png';
import Cargostep3 from '../assets/images/Cargostep3.png';
import Cargostep4 from '../assets/images/Cargostep4.png';
import Cargostep5 from '../assets/images/Cargostep5.png';
import Cargostep6 from '../assets/images/Cargostep6.png';
...
function CargoSteps() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-2 md:px-0">
      ...
      <div className="flex w-full gap-8 md:gap-0 overflow-x-auto scrollbar-hidden scroll-smooth" ref={containerRef}>
