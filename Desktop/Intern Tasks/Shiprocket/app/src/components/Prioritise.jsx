...
function Prioritise() {
  return (
    <div className='max-w-6xl mx-auto my-20 px-2'>
           <h3 className='text-5xl font-bold  my-8 text-primes'><span className='custom-gradient font-normal'>Prioritising</span> your business at every turn</h3>
            ...
            <div className='flex justify-between w-full my-6 md:flex-wrap overflow-auto scrollbar-hidden  md:overflow-hidden md:gap-y-16 gap-6 md:gap-0'>
