...
//         In good company: Brands who <span className='custom-gradient font-normal'>trust us</span>
//         </h2>
//         <div className="flex gap-10 animate-marquee overflow-hidden w-full right-0 left-0 my-10  ">
//             {
...
//                     <img src={image} alt={image} className='w-full h-full  scale-[0.8]' />
