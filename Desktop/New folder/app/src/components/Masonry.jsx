...
import Masonry1 from '../assets/images/Masonry1.png'
import Masonry2 from '../assets/images/Masonry2.png'
import Masonry3 from '../assets/images/Masonry3.png'
import Masonry4 from '../assets/images/Masonry4.png'

function Masonry() {
  return (
    <div className='max-w-6xl mx-auto px-2 md:px-0 '>
        <h3 className='text-5xl font-bold  my-8 text-primes'>Tailored next-gen <span className='custom-gradient font-normal'>solutions</span> at your fingertips</h3>
