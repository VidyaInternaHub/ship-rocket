...
function Content() {
  return (
    ...
    <div className='max-w-6xl mx-auto my-20 px-2'>
        <h2 className='text-5xl font-bold  tracking-tight my-8 text-primes'>Platform built to scale your <span className='custom-gradient'> business</span></h2>
        <div className="flex md:flex-col overflow-auto scrollbar-hidden gap-3">
