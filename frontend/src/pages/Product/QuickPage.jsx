        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row px-4 md:px-2 gap-10 md:gap-0">
            <div className="md:w-1/2 w-full flex flex-col gap-10">
              ...
              <p className="text-lg">
                With your favourite couriers, all in one app.
              </p>
              <button className="bg-burgundy text-white py-3 px-4 md:w-44 rounded-lg text-center w-full ">
                Get Started
              </button>
            </div>
            <div className="md:w-1/2 w-full">
              <img
                src={Homepage}
                alt="homepage"
                className="w-full h-full relative -top-4"
              />
            </div>
          </div>
        </div>
