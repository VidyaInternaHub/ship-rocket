...
// import shipXLogo from "../../../assets/images/products/SRX-1.svg";
...
//               <Link className="shrink-0 md:block hidden">
//                 Channel Integration
//               </Link>
//               <Link className="shrink-0 md:block hidden">
  ...
  return (
    ...
    >
      ...
      <div className="flex">
        ...
        {/* Start Shipping Now Button */}
        <div>
          <Link className="shrink-0 bg-purple-500 text-white px-2 py-2 xs:text-xs sm:text-sm rounded-full">
            Try for free
          </Link>
        </div>
      </div>
