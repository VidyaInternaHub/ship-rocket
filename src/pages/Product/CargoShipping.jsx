        ...
        <div className="flex md:flex-row lg:ml-48 ml-3 gap-10 flex-col ">
          <div className="md:w-1/2 w-full px-2">
            <div className="text-container flex flex-col justify-center gap-10 ">
              <h3 className="text-6xl  font-bold  leading-16 text-primes">
                Tech-enabled shipping solutions for all your{" "}
                <span className="text-gradient1 font-medium">
                  heavy & bulk shipments
                </span>
              </h3>
              <p className=" text-[#666] text-lg">
                Elevate your business with our comprehensive B2B cargo shipping
                solution at a single platform. Streamline the entire process and
                let us take care of all the heavy lifting for you.
              </p>
          ...
          <div className="md:w-1/2 w-full">
            <img
              src={Cargo}
              alt="shipping truck"
              className="md:w-[480px] md:h-[500px] md:mt-10 md:ml-6  "
            />
          </div>
        </div>
      </div>
